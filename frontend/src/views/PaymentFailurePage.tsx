...
export function PaymentFailurePage() {
  return (
    <AppShell>
      <Helmet>
        <title>Ошибка оплаты - База отдыха "Победа"</title>
        <meta name="description" content={SEO_DESCRIPTIONS.paymentFailure} />
      </Helmet>
      <div className="max-w-xl mx-auto py-12 text-center space-y-8">
        ...
        <Panel className="bg-red-50/50 border-red-100">
          <p className="text-sm text-red-800">
            Если деньги были списаны, но статус не изменился, обратитесь в нашу
            службу поддержки по телефону: +7 (900) 123-45-67.
          </p>
        </Panel>
